 ...
 * Purpose: Operator's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/operator/drizzle.config.ts
 *     (which targets Postgres); only by nodes/operator/drizzle.doltgres.config.ts.
 * Side-effects: none
...
// Drizzle-kit walks this re-export when generating migrations for knowledge_operator.
export {
  citations,
  domains,
  knowledge,
