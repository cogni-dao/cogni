...
import { PaymentsStep } from "./steps/PaymentsStep.client";
import { RepoStep } from "./steps/RepoStep.client";
import { ActiveStep, FailedStep, WalletStep } from "./steps/SimpleSteps";
...
export const WIZARD_STEP_REGISTRY: Record<NodeStatus, WizardStepEntry> = {
  ...
  wallet_ready: { Component: WalletStep, available: true },
  payments_ready: { Component: PaymentsStep, available: true },
