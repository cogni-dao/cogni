 ...
 * Notes: Facades own DTO mapping. Emits payments.verified on CREDITED transitions. buildPostCreditFundingDeps() constructs settlement deps (treasury + ledger) from container when at least one downstream port is available. Provider top-up was retired (x402 egress lands later).
