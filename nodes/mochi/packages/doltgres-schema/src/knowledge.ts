...
/**
 * Module: `@cogni/mochi-doltgres-schema/knowledge`
 * Purpose: mochi's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/mochi/drizzle.config.ts
 *     (which targets Postgres); only by nodes/mochi/drizzle.doltgres.config.ts.
 * Side-effects: none
