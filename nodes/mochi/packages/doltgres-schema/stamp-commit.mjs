...
// working set per dolthub/dolt#4843. Runs inside the mochi migrator
// image immediately after `drizzle-kit migrate` (see package.json
// db:migrate:mochi:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/mochi-doltgres-schema (copied in full by the
// mochi migrator Dockerfile). Not tree-shaken by tsup because it's not
// an entry.
