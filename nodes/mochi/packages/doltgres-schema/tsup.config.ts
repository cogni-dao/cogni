...
/**
 * Module: `@cogni/mochi-doltgres-schema/tsup.config`
 * Purpose: Build configuration for @cogni/mochi-doltgres-schema — mochi's node-local Drizzle schema for the Doltgres knowledge plane.
 ...
 * Side-effects: IO
 * Links: docs/spec/packages-architecture.md, work/items/task.5077.mochi-doltgres-substrate.md
 * @internal
 */
