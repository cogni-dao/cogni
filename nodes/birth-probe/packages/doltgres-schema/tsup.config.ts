...
/**
 * Module: `@cogni/birth-probe-doltgres-schema/tsup.config`
 * Purpose: Build configuration for @cogni/birth-probe-doltgres-schema — birth-probe's node-local Drizzle schema for the Doltgres knowledge plane.
 ...
 * Side-effects: IO
 * Links: docs/spec/packages-architecture.md, work/items/task.5077.birth-probe-doltgres-substrate.md
 * @internal
 */
