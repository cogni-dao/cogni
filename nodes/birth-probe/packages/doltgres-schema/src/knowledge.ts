...
/**
 * Module: `@cogni/birth-probe-doltgres-schema/knowledge`
 * Purpose: birth-probe's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/birth-probe/drizzle.config.ts
 *     (which targets Postgres); only by nodes/birth-probe/drizzle.doltgres.config.ts.
 * Side-effects: none
