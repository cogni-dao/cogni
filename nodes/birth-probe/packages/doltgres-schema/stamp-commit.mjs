...
// working set per dolthub/dolt#4843. Runs inside the birth-probe migrator
// image immediately after `drizzle-kit migrate` (see package.json
// db:migrate:birth-probe:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/birth-probe-doltgres-schema (copied in full by the
// birth-probe migrator Dockerfile). Not tree-shaken by tsup because it's not
// an entry.
