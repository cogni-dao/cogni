...
/**
 * Module: `@cogni/chaos-doltgres-schema/knowledge`
 * Purpose: chaos's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/chaos/drizzle.config.ts
 *     (which targets Postgres); only by nodes/chaos/drizzle.doltgres.config.ts.
 * Side-effects: none
