...
/**
 * Module: `@cogni/chaos-doltgres-schema/tsup.config`
 * Purpose: Build configuration for @cogni/chaos-doltgres-schema — chaos's node-local Drizzle schema for the Doltgres knowledge plane.
 ...
 * Side-effects: IO
 * Links: docs/spec/packages-architecture.md, work/items/task.5077.chaos-doltgres-substrate.md
 * @internal
 */
