...
// working set per dolthub/dolt#4843. Runs inside the chaos migrator
// image immediately after `drizzle-kit migrate` (see package.json
// db:migrate:chaos:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/chaos-doltgres-schema (copied in full by the
// chaos migrator Dockerfile). Not tree-shaken by tsup because it's not
// an entry.
