...
/**
 * Module: `@cogni/hello-world-doltgres-schema/tsup.config`
 * Purpose: Build configuration for @cogni/hello-world-doltgres-schema — hello-world's node-local Drizzle schema for the Doltgres knowledge plane.
 ...
 * Side-effects: IO
 * Links: docs/spec/packages-architecture.md, work/items/task.5077.hello-world-doltgres-substrate.md
 * @internal
 */
