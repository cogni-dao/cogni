...
// working set per dolthub/dolt#4843. Runs inside the hello-world migrator
// image immediately after `drizzle-kit migrate` (see package.json
// db:migrate:hello-world:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/hello-world-doltgres-schema (copied in full by the
// hello-world migrator Dockerfile). Not tree-shaken by tsup because it's not
// an entry.
