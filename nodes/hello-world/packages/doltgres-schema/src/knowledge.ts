...
/**
 * Module: `@cogni/hello-world-doltgres-schema/knowledge`
 * Purpose: hello-world's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/hello-world/drizzle.config.ts
 *     (which targets Postgres); only by nodes/hello-world/drizzle.doltgres.config.ts.
 * Side-effects: none
