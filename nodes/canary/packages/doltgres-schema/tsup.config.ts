...
/**
 * Module: `@cogni/canary-doltgres-schema/tsup.config`
 * Purpose: Build configuration for @cogni/canary-doltgres-schema — canary's node-local Drizzle schema for the Doltgres knowledge plane.
 ...
 * Side-effects: IO
 * Links: docs/spec/packages-architecture.md, work/items/task.5077.canary-doltgres-substrate.md
 * @internal
 */
