...
// working set per dolthub/dolt#4843. Runs inside the canary migrator
// image immediately after `drizzle-kit migrate` (see package.json
// db:migrate:canary:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/canary-doltgres-schema (copied in full by the
// canary migrator Dockerfile). Not tree-shaken by tsup because it's not
// an entry.
