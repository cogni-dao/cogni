...
/**
 * Module: `@cogni/canary-doltgres-schema/knowledge`
 * Purpose: canary's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/canary/drizzle.config.ts
 *     (which targets Postgres); only by nodes/canary/drizzle.doltgres.config.ts.
 * Side-effects: none
