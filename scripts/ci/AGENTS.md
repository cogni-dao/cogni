...
- **Fast-path classifier env:** `EVENT_NAME`, `REPOSITORY`, `PR_NUMBER_PR`, `PR_HEAD_SHA_PR`, `MQ_HEAD_REF`, `MQ_BASE_SHA`, `MQ_HEAD_SHA`; `FAST_PATH_{PR,COMMIT,FILES}_JSON` are hermetic test seams only
