...
on every env**. As of **2026-06-24** it is **proven end-to-end (incl. take-effect) on
candidate-a AND production**; only **preview** is still blocked (its OpenFGA authz layer is down).
